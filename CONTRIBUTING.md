...
🙏 Thank you for your interest in contributing to the **Sanskritam Programming Language (SPL)**.
...
- [🗂️ Repository Structure (Planned)](#️-repository-structure-planned)
- [🧪 Development Guidelines](#-development-guidelines)
- [🐞 Reporting Issues](#-reporting-issues)
- [💡 Proposing Features (RFC Process)](#-proposing-features-rfc-process)
- [🔐 Legal & Licensing](#-legal--licensing)
- [🧪 Testing](#-testing)
- [📄 Academic & Research Contributions](#-academic--research-contributions)
...
Before contributing, please align with SPL’s core principles:
...
```text
spl/
├── compiler/ # C++ compiler and semantic engine
├── runtime/ # Execution runtime
├── ir/ # Semantic Intermediate Representation
├── ai/ # AI-native constructs and backends
├── examples/ # SPL example programs
├── docs/ # Specifications and research docs
...
📧 devanand [at] brahmandx.com

---

🕉️ *Thank you for helping build the future of meaning-driven computation.*
